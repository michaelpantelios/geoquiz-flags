...
import libya_emblem from "../assets/images/flagSpecials/libya/libya_emblem.png";

export class Libya extends PIXI.Container {
    constructor(data) {
        super();
        ...
        this.area4 = new PIXI.Sprite.from(libya_emblem);
