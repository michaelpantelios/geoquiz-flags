...
export class Niger extends PIXI.Container {
    constructor(data) {
        super();
        ...
        this.circleRadius = 0.4 * this._areaHeight;
    ...
    paintFlagArea(name, color){
        ...
        switch(name){
            ...
            case this.area4.name:
                ...
                this.area4.drawCircle(this._flagWidth / 2 , this._flagHeight / 2, this.circleRadius);
                this.area4.endFill();
                break;
        }
    }
