    ...
    paintFlagArea(name, color){
        ...
        switch(name){
            case this.area1.name:
                ...
                this.area1.drawRect(0, 0, this._area1Width,  this._area1Height);
                this.area1.endFill();
                break;
            case this.area2.name:
                ...
                this.area2.drawRect(0, 0, this._flagWidth - this._area1Width, this._area1Height);
                this.area2.endFill();
                this.area2.x = this._area1Width;
                break;
            case this.area3.name:
                this.area3.clear();
                this.area3.lineStyle(this._lineWidth, 0x000000, 1);
                this.area3.beginFill(color);
                this.area3.drawRect(0, 0, this._flagWidth, this._flagHeight / 2);
                this.area3.endFill();
                this.area3.y = this._flagHeight / 2;
                break;
        }
    }
