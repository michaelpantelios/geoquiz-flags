...
import egypt_emblem from "../assets/images/flagSpecials/egypt/egypt_emblem.png";

export class Egypt extends PIXI.Container {
    constructor(data) {
        super();
        ...
        this.area4 = new PIXI.Sprite.from(egypt_emblem);
