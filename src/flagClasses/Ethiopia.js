...
import ethiopia_emblem from "../assets/images/flagSpecials/ethiopia/ethiopia_emblem.png";

export class Ethiopia extends PIXI.Container {
    constructor(data) {
        super();
        ...
        this.area4 = new PIXI.Sprite.from(ethiopia_emblem);
