...
export class Vietnam extends PIXI.Container {
    constructor(data) {
        ...
        this.star3 = new PIXI.Point(0.69 * this._flagWidth, 0.40 * this._flagHeight);
        this.star4 = new PIXI.Point(0.57 * this._flagWidth, 0.53 * this._flagHeight);
        this.star5 = new PIXI.Point(0.62 * this._flagWidth, 0.74 * this._flagHeight);
        this.star6 = new PIXI.Point(0.5 * this._flagWidth, 0.61 * this._flagHeight);
        this.star7 = new PIXI.Point(0.37 * this._flagWidth, 0.74 * this._flagHeight);
        this.star8 = new PIXI.Point(0.42 * this._flagWidth, 0.53 * this._flagHeight);
        this.star9 = new PIXI.Point(0.29 * this._flagWidth, 0.40 * this._flagHeight);
        this.star10 = new PIXI.Point(0.45 * this._flagWidth, 0.40 * this._flagHeight);
