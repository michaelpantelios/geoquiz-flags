...
export class Mauritius extends PIXI.Container {
    constructor(data) {
        super();
        ...
        this._areaHeight = this._flagHeight * 0.25;
    ...
    paintFlagArea(name, color){
        ...
        switch(name){
            ...
            case this.area4.name:
                ...
                this.area4.drawRect(0, 3 * this._areaHeight, this._flagWidth, this._areaHeight);
                this.area4.endFill();
                break;
        }
    }
