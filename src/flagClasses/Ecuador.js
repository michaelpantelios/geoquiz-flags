...
import equador_emblem from "../assets/images/flagSpecials/equador/ecuador_ec.png";

export class Ecuador extends PIXI.Container {
    constructor(data) {
        super();
        ...
        //wrong colors
        this.wrongColor1 = 0xffffff;
        this.wrongColor2 = 0x000000;
        this.wrongColor3 = 0x2a7d07;

        this.area1Height = 0.5 * this._flagHeight;
        this.area2Height = 0.25 * this._flagHeight;
        ...
        this.area4 = new PIXI.Sprite.from(equador_emblem);
    ...
    paintFlagArea(name, color){
        ...
        switch(name){
            ...
            case this.area3.name:
                ...
                this.area3.drawRect(0, this.area1Height+this.area2Height, this._flagWidth, this.area2Height);
                this.area3.endFill();
                break;
        }
    }
