...
import moldova_emblem from "../assets/images/flagSpecials/moldova/moldova_emblem.png";

export class Moldova extends PIXI.Container{
    constructor(data) {
        super();
        ...
        this.area4 = new PIXI.Sprite.from(moldova_emblem);
