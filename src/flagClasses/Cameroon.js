...
import cameroon_emblem from "../assets/images/flagSpecials/cameroon/cameroon_emblem.png";

export class Cameroon extends PIXI.Container{
    constructor(data) {
        super();
        ...
        this.area4 = new PIXI.Sprite.from(cameroon_emblem);
