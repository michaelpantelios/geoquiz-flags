...
export class UnitedArabEmirates extends PIXI.Container {
    constructor(data){
        super();
        ...
        this._area4Width = 0.25 * this._flagWidth;
    ...
    paintFlagArea(name, color){
        ...
        switch(name){
            ...
            case this.area2.name:
                ...
                this.area2.drawRect(0,  this._area1Height, this._flagWidth, this._area1Height);
                this.area2.endFill();
                break;
            case this.area3.name:
                ...
                this.area3.drawRect(0, 2 * this._area1Height, this._flagWidth, this._area1Height);
                this.area3.endFill();
                break;
            case this.area4.name:
                ...
                this.area4.drawRect(0, 0, this._area4Width, this._flagHeight);
                this.area4.endFill();
                break;
