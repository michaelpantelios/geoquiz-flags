...
import singapore_emblem from "../assets/images/flagSpecials/singapore/singapore_emblem.png";

export class Singapore extends PIXI.Container {
    constructor(data) {
        super();
        ...
        this.emblemX = 0.064 * this._flagWidth;
        this.emblemY = 0.09 * this._flagHeight;
        ...
        this.area3 = new PIXI.Sprite.from(singapore_emblem);
