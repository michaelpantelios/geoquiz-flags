...
export class Namimbia extends PIXI.Container {
    constructor(data) {
        ...
        this._area3_3 = new PIXI.Point(this._flagWidth,0.285 * this._flagHeight);
        this._area3_4 = new PIXI.Point(0.199 * this._flagWidth,this._flagHeight);
        this._area3_5 = new PIXI.Point(0, this._flagHeight);

        this._area4_0 = new PIXI.Point(0, 0.742 * this._flagHeight);
        this._area4_1 = new PIXI.Point(0.854 * this._flagWidth,0);
        this._area4_2 = new PIXI.Point(this._flagWidth,0);
        this._area4_3 = new PIXI.Point(this._flagWidth,0.233 * this._flagHeight);
        this._area4_4 = new PIXI.Point(0.148 * this._flagWidth, this._flagHeight);
        ...
        this.area5 = new PIXI.Sprite.from(namimbia_emblem);
    ...
    paintFlagArea(name, color){
        ...
        switch(name){
            ...
            case this.area4.name:
                ...
                this.area4.lineTo(this._area4_5.x, this._area4_4.y);
