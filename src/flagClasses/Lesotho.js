...
import lesotho_emblem from "../assets/images/flagSpecials/lesotho/lesotho_emblem.png";

export class Lesotho extends PIXI.Container {
    constructor(data) {
        super();
        ...
        this.area1Height = 0.3 * this._flagHeight;
        this.area2Height = 0.4 * this._flagHeight;
        ...
        this.area4 = new PIXI.Sprite.from(lesotho_emblem);
