...
import peru_emblem from "../assets/images/flagSpecials/peru/peru_emblem.png";

export class Peru extends PIXI.Container {
    constructor(data) {
        super();
        ...
        this.area4 = new PIXI.Sprite.from(peru_emblem);
