...
import wales_emblem from "../assets/images/flagSpecials/wales/wales_emblem.png";

export class Wales extends PIXI.Container {
    constructor(data) {
        super();
        ...
        this.area3 = new PIXI.Sprite.from(wales_emblem);
