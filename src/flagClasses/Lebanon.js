...
import lebanon_emblem from "../assets/images/flagSpecials/lebanon/lebanon_emblem.png";

export class Lebanon extends PIXI.Container {
    constructor(data) {
        super();
        ...
        this.area4 = new PIXI.Sprite.from(lebanon_emblem);
