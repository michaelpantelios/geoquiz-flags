...
import venezuela_emblem from "../assets/images/flagSpecials/venezuela/venezuela_emblem.png";

export class Venezuela extends PIXI.Container {
    constructor(data) {
        super();
        ...
        this.areaHeight = 0.33 * this._flagHeight;
        ...
        this.area4 = new PIXI.Sprite.from(venezuela_emblem);
