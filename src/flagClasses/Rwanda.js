...
import rwanda_emblem from "../assets/images/flagSpecials/rwanda/rwanda_emblem.png";

export class Rwanda extends PIXI.Container {
    constructor(data) {
        super();
        ...
        this.area4 = new PIXI.Sprite.from(rwanda_emblem);
    ...
    paintFlagArea(name, color){
        ...
        switch(name){
            ...
            case this.area3.name:
                ...
                this.area3.drawRect(0, this.area1Height + this.area2Height, this._flagWidth, this.area3Height);
                this.area3.endFill();
                break;
        }
    }
