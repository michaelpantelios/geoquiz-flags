...
import elsalvador_emblem from "../assets/images/flagSpecials/elsalvador/elsalvador_emblem.png";

export class ElSalvador extends PIXI.Container {
    constructor(data) {
        super();
        ...
        this.area4 = new PIXI.Sprite.from(elsalvador_emblem);
