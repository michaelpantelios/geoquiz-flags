...
import liechtenstein_emblem from "../assets/images/flagSpecials/liechtenstein/liechtenstein_emblem.png";

export class Liechtenstein extends PIXI.Container {
    constructor(data) {
        super();
        ...
        this.area3 = new PIXI.Sprite.from(liechtenstein_emblem);
