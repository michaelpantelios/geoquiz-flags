...
import argentina_emblem from "../assets/images/flagSpecials/argentina/argentina_emblem.png";

export class Argentina extends PIXI.Container {
    constructor(data) {
        super();
        ...
        this.area4 = new PIXI.Sprite.from(argentina_emblem);
