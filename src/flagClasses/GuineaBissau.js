...
import guineabissau_emblem from "../assets/images/flagSpecials/guineabissau/guineabissau_emblem.png";

export class GuineaBissau extends PIXI.Container {
    constructor(data) {
        super();
