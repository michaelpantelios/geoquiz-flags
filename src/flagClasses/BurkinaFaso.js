...
import burkinafaso_emblem from "../assets/images/flagSpecials/burkinafaso/burkinafaso_emblem.png";

export class BurkinaFaso extends PIXI.Container{
    constructor(data) {
        super();
        ...
        this.area3 = new PIXI.Sprite.from(burkinafaso_emblem);
