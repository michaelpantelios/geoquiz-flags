...
export class Japan extends PIXI.Container {
    constructor(data) {
        super();
        ...
        this.area2Radius = 0.30 * this._flagHeight;
    ...
    paintFlagArea(name, color){
        ...
        switch(name){
            ...
            case this.area2.name:
                ...
                this.area2.drawCircle(this._flagWidth / 2, this._flagHeight / 2, this.area2Radius);
                this.area2.endFill();
                break;
        }
    }
