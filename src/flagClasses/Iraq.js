...
import iraq_emblem from "../assets/images/flagSpecials/iraq/iraq_emblem.png";

export class Iraq extends PIXI.Container {
    constructor(data) {
        super();
        ...
        this.wrongColor2 = 0x0e810e;
        this.wrongColor3 = 0xffff00;

        this.area1Height = 0.28 * this._flagHeight;
        this.area2Height = 0.45 * this._flagHeight;
        ...
        this.area4 = new PIXI.Sprite.from(iraq_emblem);
