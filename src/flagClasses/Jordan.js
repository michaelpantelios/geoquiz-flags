...
import jordan_emblem from "../assets/images/flagSpecials/jordan/jordan_emblem.png";

export class Jordan extends PIXI.Container {
    constructor(data) {
        super();
        ...
        this.wrongColor3 = 0x00d4d4;

        this._areaHeight = this._flagHeight * 0.3333;
        this._triangleWidth = 0.75 * this._flagWidth;
        this._emblemX = 0.07 * this._flagWidth;
        ...
        this.area5 = new PIXI.Sprite.from(jordan_emblem);
