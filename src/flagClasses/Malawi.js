...
import malawi_emblem from "../assets/images/flagSpecials/malawi/malawi_emblem.png";

export class Malawi extends PIXI.Container {
    constructor(data) {
        super();
        ...
        this.area4 = new PIXI.Sprite.from(malawi_emblem);
