...
import azerbaijan_emblem from "../assets/images/flagSpecials/azerbaijan/azerbaijan_emblem.png";

export class Azerbaijan extends PIXI.Container {
    constructor(data) {
        super();
        ...
        this.area4 = new PIXI.Sprite.from(azerbaijan_emblem);
