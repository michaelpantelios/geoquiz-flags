...
export class SouthSudan extends PIXI.Container {
    constructor(data) {
        ...
        this._area4Height = 0.3 * this._flagHeight; // black, interactive
        this._area4Y = 0.35 * this._flagHeight;
        this._area5Width = 0.65 * this._flagWidth;
        this._emblemX = 0.079 * this._flagWidth;
        ...
        this.area5Color = parseInt(this._flagData["correctColors"][4]["area5"]); // cyan
        ...
        this.area6 = new PIXI.Sprite.from(southsudan_emblem);
