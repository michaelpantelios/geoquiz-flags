...
import bolivia_emblem from "../assets/images/flagSpecials/bolivia/bolivia_emblem.png";

export class Bolivia extends PIXI.Container{
    constructor(data) {
        super();
        ...
        this.area4 = new PIXI.Sprite.from(bolivia_emblem);
