...
export class Uzbekistan extends FlagBaseClass {
    constructor(data) {
        ...
        this._area3Height = 0.31 * this._flagHeight;
        this._area4Height = 0.32 * this._flagHeight;
        this._area4Y = 0.34 * this._flagHeight;

        this.emblemPos = new PIXI.Point(0.13 * this._flagWidth, 0.047 * this._flagHeight);
        ...
        this.area5 = new PIXI.Sprite.from(uzbekistan_emblem);
        this.area5.scale.set(this._scale);
        this.area5.visible = false;
        this.addChild(this.area5);
        setTimeout(()=>{
            this.area5.x = this.emblemPos.x;
            this.area5.y = this.emblemPos.y;
    ...
    paintFlagArea(name, color) {
        ...
        switch(name){
            ...
            case this.area3.name:
                ...
                this.area3.drawRect(0, this._area1Height+this._area2Height, this._flagWidth, this._area3Height);
                this.area3.endFill();
                break;
