...
import andora_emblem from "../assets/images/flagSpecials/andora/andora_emblem.png";

export class Andora extends PIXI.Container{
    constructor(data) {
        super();
        ...
        this.area4 = new PIXI.Sprite.from(andora_emblem);
