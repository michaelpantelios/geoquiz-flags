...
import barbados_emblem from "../assets/images/flagSpecials/barbados/barbados_emblem.png";

export class Barbados extends PIXI.Container{
    constructor(data) {
        super();
        ...
        this.area4 = new PIXI.Sprite.from(barbados_emblem);
