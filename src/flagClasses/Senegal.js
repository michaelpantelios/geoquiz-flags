...
import senegal_emblem from "../assets/images/flagSpecials/senegal/senegal_emblem.png";

export class Senegal extends PIXI.Container {
    constructor(data) {
        super();
        ...
        this.area4 = new PIXI.Sprite.from(senegal_emblem);
