...
import syria_emblem from "../assets/images/flagSpecials/syria/syria_emblem.png";

export class Thailand extends PIXI.Container {
    constructor(data) {
        super();
        ...
        this.area1Height = 0.16 * this._flagHeight;
        this.area3Height = 0.36 * this._flagHeight;
    ...
    paintFlagArea(name, color){
        ...
        switch(name){
            ...
            case this.area3.name:
                ...
                this.area3.drawRect(0, 2 * this.area1Height, this._flagWidth, this.area3Height);
                this.area3.endFill();
                break;
            case this.area4.name:
                ...
                this.area4.drawRect(0, 2 * this.area1Height + this.area3Height, this._flagWidth , this.area1Height);
                this.area4.endFill();
                break;
            case this.area5.name:
                ...
                this.area5.drawRect(0, 3 * this.area1Height + this.area3Height, this._flagWidth, this.area1Height);
                this.area5.endFill();
                break;
        }
    }
