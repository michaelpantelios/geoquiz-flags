...
export class Laos extends PIXI.Container {
    constructor(data) {
        super();
        ...
        this.area4Radius = 0.2 * this._flagHeight;
    ...
    paintFlagArea(name, color){
        ...
        switch(name){
            ...
            case this.area4.name:
                ...
                this.area4.drawCircle(this._flagWidth / 2,this._flagHeight / 2, this.area4Radius);
                this.area4.endFill();
                break;
        }
    }
