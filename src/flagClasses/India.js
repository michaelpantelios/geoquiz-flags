...
import india_emblem from "../assets/images/flagSpecials/india/india_emblem.png";

export class India extends PIXI.Container {
    constructor(data) {
        super();
        ...
        this.area4 = new PIXI.Sprite.from(india_emblem);
