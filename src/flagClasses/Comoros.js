...
import comoros_emblem from "../assets/images/flagSpecials/comoros/comoros_emblem.png";

export class Comoros extends PIXI.Container {
    constructor(data) {
        super();
        ...
        this.area6 = new PIXI.Sprite.from(comoros_emblem);
    ...
    paintFlagArea(name, color){
        ...
        switch(name){
            case this.area1.name:
                ...
                this.area1.drawRect(0, 0, this._flagWidth, this._flagHeight / 4);
                this.area1.endFill();
                break;
            case this.area2.name:
                ...
                this.area2.drawRect(0, 0, this._flagWidth, this._flagHeight / 4);
                this.area2.endFill();
                this.area2.y = this._flagHeight / 4;
                break;
            case this.area3.name:
                this.area3.clear();
                this.area3.lineStyle( this._lineWidth, 0x000000, 1);
                this.area3.beginFill(color);
                this.area3.drawRect(0, 0, this._flagWidth, this._flagHeight / 4);
                this.area3.endFill();
                this.area3.y = 2 * this._flagHeight / 4;
                break;
            case this.area4.name:
                this.area4.clear();
                this.area4.lineStyle( this._lineWidth, 0x000000, 1);
                this.area4.beginFill(color);
                this.area4.drawRect(0, 0, this._flagWidth, this._flagHeight / 4);
                this.area4.endFill();
                this.area4.y = 3 * (this._flagHeight / 4);
                break;
