...
export class Colombia extends PIXI.Container {
    constructor(data) {
        super();
    ...
    paintFlagArea(name, color){
        ...
        switch(name){
            ...
            case this.area2.name:
                ...
                this.area2.drawRect(0, this._flagHeight / 2, this._flagWidth, this._flagHeight / 4);
                this.area2.endFill();
                break;
            case this.area3.name:
                this.area3.lineStyle(this._lineWidth, 0x000000, 1);
                this.area3.beginFill(color);
                this.area3.drawRect(0, (3 / 4) * this._flagHeight , this._flagWidth, this._flagHeight / 4);
                this.area3.endFill();
                break;
        }
    }
