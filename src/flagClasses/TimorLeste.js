...
import timorleste_emblem from "../assets/images/flagSpecials/timorleste/timorleste_emblem.png";

export class TimorLeste extends PIXI.Container {
    constructor(data) {
        super();
        ...
        this.area2Width = 0.75 * this._flagWidth;
        this.area3Width = 0.5 * this._flagWidth;
        this._emblemPos = new PIXI.Point(0.035 * this._flagWidth, 0.5 * this._flagHeight);
    ...
    paintFlagArea(name, color){
        ...
        switch(name){
            ...
            case this.area2.name:
                ...
                this.area2.lineTo(this.area2Width, 0.5 * this._flagHeight);
            ...
            case this.area3.name:
                ...
                this.area3.lineTo(this.area3Width, 0.5 * this._flagHeight);
